  ...
  return (
    <div className="bg-white py-20 w-full">
      <div className="w-full px-6 md:px-12 lg:px-16">
        <div className="relative bg-gradient-to-r from-gray-100 to-gray-50 overflow-hidden rounded-3xl p-12 max-w-6xl mx-auto">
          {/* Background effects */}
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
            <div className="absolute top-0 left-1/4 w-64 h-64 bg-red-100 rounded-full filter blur-3xl"></div>
            <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-blue-100 rounded-full filter blur-3xl"></div>
          </div>
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <h2 className="mb-6">
              <span className="text-black font-light">Experience The Future </span>
              <span className="bg-gradient-to-r from-red-500 via-purple-500 to-blue-500 bg-clip-text text-transparent font-bold">Today</span>
            </h2>
