  ...
  return <div className="max-w-4xl mx-auto text-center mb-16">
      ...
      delay: 0.3
        ...
        Reality redefined. <DecryptedText 
          ...
          encryptedClassName="text-lg md:text-xl text-gray-500"
          speed={80}
          maxIterations={12}
          sequential={true}
      ...
      delay: 0.6
        ...
        <GradientButton className="px-8 py-6 text-lg font-medium tracking-wide">
          <DecryptedText 
            ...
            encryptedClassName="text-lg font-medium tracking-wide text-white/50"
            speed={60}
            maxIterations={10}
            sequential={true}
        ...
        <GradientButton variant="variant" className="px-8 py-6 text-lg font-medium tracking-wide group">
          <DecryptedText 
            ...
            encryptedClassName="text-lg font-medium tracking-wide text-gray-400"
            speed={60}
            maxIterations={10}
            sequential={true}
            characters="ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"
