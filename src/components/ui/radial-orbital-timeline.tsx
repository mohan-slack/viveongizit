...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full min-h-[500px] md:min-h-[600px] flex flex-col items-center justify-center bg-transparent overflow-hidden py-8"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          {/* Center Ring Image */}
          <div className="absolute w-24 h-24 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-purple-500 via-blue-500 to-teal-500 flex items-center justify-center z-10 shadow-2xl">
            <div className="absolute w-28 h-28 md:w-36 md:h-36 rounded-full border border-white/20 animate-ping opacity-70"></div>
            <div
            ...
            {centerImage ? (
              ...
              <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-white/80 backdrop-blur-md"></div>
            )}
          </div>
