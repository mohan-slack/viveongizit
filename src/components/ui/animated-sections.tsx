...
const defaultSections: SectionData[] = [
  {
    text: "Introducing HUX™ Smart Rings",
    img: "/lovable-uploads/79d25ec2-5c04-4a40-9026-55fa0d6de5cb.png"
  },
  {
    text: "Advanced Health Monitoring",
    img: "/lovable-uploads/00c5fdc2-4f6d-460b-ac18-8a2de360924e.png"
  },
  {
    text: "Smart Touch Control",
    img: "/lovable-uploads/e812100c-209b-4b76-a293-8265a3972c6c.png"
  },
  {
    text: "Calling & Vibration Features",
    img: "/lovable-uploads/4eddb246-9aa6-47a7-9126-4df24a770051.png"
  },
  {
    text: "Media Control Innovation",
    img: "/lovable-uploads/5f3e7716-5076-4d16-94ef-fc27416b19b2.png"
  }
];
...
const AnimatedSections: React.FC<AnimatedSectionsProps> = ({
  ...
  return (
    <div 
      ref={containerRef}
      className={`h-screen w-screen overflow-hidden bg-viveon-darker text-white uppercase font-sans ${className}`}
    >
      ...
      <div className="fixed bottom-4 right-6 z-30 flex items-center gap-4">
        ...
        {/* Counter */}
        <div className="text-xs md:text-sm tracking-wider flex items-center gap-1 text-primary/80">
        ...
        >
          <div className="outer w-full h-full overflow-hidden" ref={(el) => { if (el) outerRefs.current[i] = el; }}>
            <div className="inner w-full h-full overflow-hidden" ref={(el) => { if (el) innerRefs.current[i] = el; }}>
              ...
              >
                <h2 className="section-heading text-white text-center font-semibold w-[90vw] max-w-[1200px] text-[clamp(2rem,6vw,8rem)] normal-case leading-none z-10 tracking-wide" ref={(el) => { if (el) headingRefs.current[i] = el; }}>
                  {section.text}
                </h2>
              </div>
            </div>
